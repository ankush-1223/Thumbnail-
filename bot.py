...
def main_menu():
    return InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("Reset Thumbnail", callback_data="reset_thumb"),
...
async def start(client, message):
    await message.reply_text(
        "Welcome! Clone to target channel with watermark/thumbnail.",
...
async def handle_input(client, message):
    ...
    global target_channel, default_thumb
...
async def clone_message(message):
    global target_channel, default_thumb
